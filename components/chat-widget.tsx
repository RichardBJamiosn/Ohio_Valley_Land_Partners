...
export function ChatWidget() {
  ...
  // Pages WITHOUT forms: show the GHL widget (visible, for compliance)
  // Pages WITH forms: show our custom branded chat widget
  if (!hasForm) {
    return (
      <Script
  ...
  // Pages WITH forms: custom branded chat widget (no phone field = no opt-in conflict)
  return (
