        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-4 py-2">
              ...
              <span className="text-sm font-semibold text-primary">Community Partners</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl leading-tight">
              Every Deal Gives Back
              <span className="block text-primary mt-2">to the Ohio Valley.</span>
            </h1>
      ...
      <section className="py-12 border-t border-b border-border bg-card">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 text-center">
            ...
            <div className="flex flex-col items-center gap-2 p-6">
              <span className="text-4xl font-black text-primary">Ohio Valley</span>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-accent font-medium mt-1">{partner.tagline}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-auto pt-4 border-t border-border">
                    ...
                    <a
                      ...
                      className="ml-auto inline-flex items-center gap-1 text-xs font-semibold text-accent hover:text-accent/80 transition-colors"
                    >
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          <div className="rounded-2xl border border-border bg-card p-8 sm:p-10">
            ...
            <div className="mt-6 flex flex-wrap gap-4">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-5 py-2.5 text-sm font-bold text-foreground hover:border-accent/50 transition-colors"
              >
                Contact Us
              </Link>
            </div>
